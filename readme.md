...
OctoDiary — это многокомпонентная система, разработанная для удобного доступа к информации из МЭШ и Моей школы МО. Проект включает в себя основное Android-приложение, встроенный контент-сервер на Node.js/TypeScript.
...
*   **Сборка MCP сервера ИИ бота:** NPM.
