...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>onnxruntime</b> with <b>com.microsoft.onnxruntime:onnxruntime-android</b> coordinates and
    ...
    /**
     * Dependency provider for <b>pdfbox</b> with <b>com.github.TomRoush:pdfbox-android</b> coordinates and
     * with version reference <b>pdfbox.android</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>zoomable</b> with <b>me.saket.telephoto:zoomable</b> coordinates and
     * with version reference <b>zoomable</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class AndroidxGlanceLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>glance.appwidget</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         ...
         * with version reference <b>glance.material3</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PdfboxVersionAccessors vaccForPdfboxVersionAccessors = new PdfboxVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>zoomable</b> with value <b>1.0.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.glance</b>
         */
        ...
        /**
         * Group of versions at <b>versions.pdfbox</b>
         */
        public PdfboxVersionAccessors getPdfbox() {
            return vaccForPdfboxVersionAccessors;
        }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose.bom</b> with value <b>2024.08.00</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GlanceVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>glance.appwidget</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>glance.material3</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterial3() { return getVersion("glance.material3"); }
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lifecycle.runtime.ktx</b> with value <b>2.8.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MaterialVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>material</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class MaterialIconsVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.icons.extended</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class PdfboxVersionAccessors extends VersionFactory  {

        public PdfboxVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>pdfbox.android</b> with value <b>1.8.10.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroid() { return getVersion("pdfbox.android"); }
    ...
    public static class RuntimeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>runtime.livedata</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
